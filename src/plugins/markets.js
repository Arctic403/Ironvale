...
export function getMarketPrice(asset, now=Date.now(), volatilityMultiplier=1){
 ...
 const wave=(normalized-.5)*2*asset.volatility*Math.max(.25,Number(volatilityMultiplier)||1);
