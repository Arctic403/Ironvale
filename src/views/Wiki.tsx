  ...
  const articles = useMemo<WikiArticle[]>(() => [
    ...
    },
    {
      ...
      content: <>
        ...
        <p><b>Pickpocketing:</b> A live pedestrian stream replaces scouting. NPC archetypes walk, wait, jog, rush and cycle through the city on short timers. Waiting or passing costs nothing; Nerve is spent only when you attempt the target. Mastery gradually reveals wealth, awareness, exact odds/value and danger intel. The pedestrian mix changes with real RiftCity time.</p>
        <p><b>Burglary / Vehicle Theft:</b> These keep rotating target boards and scouting because preparation belongs in those careers. Scouting reveals clearer risk/payout information and grants a success bonus.</p>
        ...
        <p><b>Operations:</b> Fraud, forgery, chop-shop, deliveries, smuggling and similar activities run while you play elsewhere. Fixed-timer operations resolve at completion, while risk-build operations such as Card Skimming and Underground Gambling can be cashed out early: value climbs over time, but so does detection pressure. They remain abstract game systems and do not model real-world criminal procedures.</p>
        <p><b>Signature mechanics:</b> Several action careers now read live conditions instead of sharing one static roll: Parcel Theft follows delivery waves, Locker Theft follows quiet foot-traffic windows, Commercial Burglary follows business hours/patrols, Safecracking uses a fictional timing pulse, Art Theft follows buyer demand, Parts Theft follows market demand, Data Theft follows an abstract security-gap pulse, Cargo Theft combines manifest value/patrol pressure, and Evidence Cleanup reacts to current Heat.</p>
