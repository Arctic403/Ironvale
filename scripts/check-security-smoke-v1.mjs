...
for (const token of [
  '/app.js?v=20260906-island-v3-r1',
...
assert(app.includes("APP_DIAGNOSTIC_BUILD = '20260906-island-v3-r1'"), 'diagnostic build tag not bumped');
assert(integrityCheck.includes('/app.js?v=20260906-island-v3-r1'), 'integrity verifier app cache contract stale');
