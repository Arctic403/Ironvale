...
for (const name of ['memory','rift_core_version','rift_terrain_init','rift_terrain_generate_island','rift_terrain_sample_height','rift_terrain_apply_brush','rift_terrain_build_chunk','rift_terrain_build_section','rift_terrain_raycast']) {
