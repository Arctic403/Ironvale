...
assert(index.includes('/app.js?v=20260902-terrain-pack-r1') || index.includes('/app.js?v=20260902-integrity-v1') || index.includes('/app.js?v=20260902-dirty-region-r1') || index.includes('/app.js?v=20260901-terrain-profiler-r1'),'recognized app cache tag missing');
