...
const reticlePoint = riftReticleClientPoint({ getBoundingClientRect: () => ({ left: 20, top: 10, width: 300, height: 180 }) });
if (reticlePoint[0] !== 170 || reticlePoint[1] !== 100) throw new Error('shared reticle target is not locked to canvas center');
